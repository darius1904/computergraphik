...
void aufgabe1(const std::string& source_file, const std::string& target_file)
{
    try
    {
        ...
        auto img=cg::image_io::load_rgb_image(source_file);
        auto conv_img=cg::image_converter::rgb_to_gray(img);
        cg::image_io::save_grayscale_image(target_file, conv_img);
...
void aufgabe2(const std::string& source_file, const std::string& target_file)
{
    try
    {
        ...
        auto img=cg::image_io::load_grayscale_image(source_file);
        auto conv_img=cg::image_converter::gray_to_bw(img);
        cg::image_io::save_bw_image(target_file, conv_img);
...
void aufgabe3(const std::string& source_file, const std::string& target_file)
{
    try
    {
        ...
        auto img=cg::image_io::load_rgb_image(source_file);
        auto conv_img=cg::image_converter::rgb_to_hsv(img);
        auto original_img=cg::image_converter::hsv_to_rgb(conv_img);
        cg::image_io::save_rgb_image(target_file,original_img);
...
void aufgabe4(const std::string& source_file, const std::string& target_file)
{
    try
    {
        ...
        auto img=cg::image_io::load_rgb_image(source_file);
        auto conv_img=cg::image_converter::rgb_to_hsv(img);
        auto adjusted_image=cg::image_manipulation::modify_in_hsv(conv_img);
        auto back_to_rgb=cg::image_converter::hsv_to_rgb(adjusted_image);
        cg::image_io::save_rgb_image(target_file,back_to_rgb);
